...
//      debugger;
        ...
        if (a8 != undefined) {
        	...
        	for(var i=0;i<a8.classList.length;i++){
        		if(a8.classList[i] === 'page-54'){
        			if(index.isOnLoad){
        				index.loadTextInputPlusHeartGarden();
        				index.isOnLoad = false;//只加载一次效果
        			}
...
(function(h, o, g) {
    var p = function() {
        for (var b = /audio(.min)?.js.*/,
        a = document.getElementsByTagName("script"), c = 0, d = a.length; c < d; c++) {
    ...
    g[h] = {
        ...
        createAll: function(b, a) {
            ...
            b = b || {};
            for (var e = 0,
            i = c.length; e < i; e++) d.push(this.newInstance(c[e], b));
            return d
        },
        ...
        attachEvents: function(b, a) {
            if (a.settings.createPlayer) {
                ...
                g[h].events.addListener(d, "click",
                function() {
                    a.playPause.apply(a)
                });
                g[h].events.addListener(e, "click",
                function(i) {
                    i = i.clientX;
                    var f = this,
                    k = 0;
                ...
                if (!a.settings.useFlash) {
                    ...
                    g[h].events.addListener(a.element, "timeupdate",
                    function() {
                        a.updatePlayhead.apply(a)
                    });
                    g[h].events.addListener(a.element, "ended",
                    function() {
                        a.trackEnded.apply(a)
                    });
                    g[h].events.addListener(a.source, "error",
                    function() {
        ...
        helpers: {
            ...
            injectCss: function(b, a) {
                for (var c = "",
                d = document.getElementsByTagName("style"), e = a.replace(/\$1/g, b.settings.imageLocation), i = 0, f = d.length; i < f; i++) {
        ...
        events: {
            ...
            ready: function() {
                return function(b) {
                    ...
                    m = function(l) {
                        if (! (l.type == "readystatechange" && e.readyState != "complete")) { (l.type == "load" ? a: e)[k](n + l.type, m, false);
    ...
    g[o].prototype = {
        ...
        play: function() { 
        	/ (ipod | iphone | ipad) / 
        	i.test(navigator.userAgent) && this.element.readyState == 0 && this.init.apply(this);
